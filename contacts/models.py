...
class User(models.Model):
    ...
    nc_year         = models.PositiveSmallIntegerField(blank=True, null=True)
    ...
    first_commway   = models.ForeignKey('Commways')
    email           = models.EmailField()
    group           = models.ManyToManyField('Group')
    picture         = models.ImageField(upload_to='pictures/', blank=True)
    picture_date    = models.DateField(blank=True, null=True)
